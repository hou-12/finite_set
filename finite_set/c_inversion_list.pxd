...
"""
    ...
    bint inversion_list_member(const InversionList *set,
                                      unsigned int value)
    ...
    bint inversion_list_equal(const InversionList *set1,
                                     const InversionList *set2)

    bint inversion_list_not_equal(const InversionList *set1,
                                         const InversionList *set2)

    bint inversion_list_less(const InversionList *set1,
                                    const InversionList *set2)

    bint inversion_list_less_equal(const InversionList *set1,
                                          const InversionList *set2)

    bint inversion_list_greater(const InversionList *set1,
                                       const InversionList *set2)

    bint inversion_list_greater_equal(const InversionList *set1,
                                             const InversionList *set2)

    bint inversion_list_disjoint(const InversionList *set1,
                                        const InversionList *set2)
    ...
    InversionList *inversion_list_difference(const InversionList *set1,
                                                    ...)

    InversionListIterator *inversion_list_iterator_create(
        const InversionList *set)

    void inversion_list_iterator_destroy(
    ...
    bint inversion_list_iterator_valid(
        const InversionListIterator *iterator)

    unsigned int inversion_list_iterator_get(
        InversionListIterator *iterator)
    ...
    void inversion_list_couple_iterator_destroy(
    ...
    bint inversion_list_iterator_couple_valid(
